...
class Agent:
    ...
    def __init__(self,rownumber):
        ...
        self.name = 'Agent' + str(rownumber)



    def action(self, last_line):
        print('Name:{},  Location:Line{}, '.format(self.name,self.rownumber), end=" ")
...
def sos(row_number):
    pascal = [[] for i in range(row_number)]
    ...
    # print(pascal)
    while True:
        "generate random number to simulate multithreading"
        i = randint(1,row_number) - 1 
